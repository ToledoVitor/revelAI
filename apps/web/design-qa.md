...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Typography         | Bundled Bebas Neue 400 provides the deliberately heavy condensed uppercase display treatment. Body copy uses the shared Inter/system fallback stack.                                                            | Same bundled display face; mobile scales and compresses the heading without truncation.                                                                        |
...
- Image Pixelmatch threshold: `0.18`. Font-ready baseline mismatch is 11.57% desktop and 13.89% mobile; the accepted limits are 12.00% and 14.50%, respectively (0.43 and 0.61 percentage-point headroom).
- Focused UI Pixelmatch threshold: `0.10`. Font-ready baseline mismatch is 4.11% desktop and 23.51% mobile; limits are 5.00% and 24.00% (0.89 and 0.49 percentage-point headroom).
- UI ink coverage floors preserve 90% of the font-ready implementation baseline: desktop navigation 416/374 pixels; mobile brand 1264/1137, headline 17232/15508, description 2315/2083.
- Negative proof: hiding desktop navigation produced only 2.01% focused pixel mismatch (so the old pixel-only comparator would have accepted it) but 0/374 navigation ink and is rejected. Hiding mobile brand/headline/description produced 21.61% focused pixel mismatch (also below the 24.00% pixel limit) but 0/1137, 0/15508, and 96/2083 ink, and is rejected.
